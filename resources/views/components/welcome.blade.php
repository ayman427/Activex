<div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
    ...
    <p class="text-gray-500 dark:text-gray-400 leading-relaxed">We are glad to have you here.</p>

    <p class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
        Welcome to ActiveX , a platform for tracking you weight, calorie, workout and other health related activities.
    </p>
</div>
...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            <h1 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="https://laravel.com/docs">Your Latest Weight</a>
            </h1>
        </div>
        ...
        <p class="mt-1 text-sm">
            <a href="{{ route('weight-tracker.index') }}" class="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300">
                Weight Tracker
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="https://laracasts.com">Today's Calorie Intake</a>
            </h2>
        </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="https://tailwindcss.com/">Latest Posts on forum</a>
            </h2>
        </div>
        ...
        @if($latestPosts->isEmpty())
                            <li class="py-4 text-gray-500 dark:text-gray-400">No posts yet</li>
                        @else
